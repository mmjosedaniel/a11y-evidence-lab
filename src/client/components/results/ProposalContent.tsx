...
export function ProposalContent({ proposal, view, reviewer = false }: {
  readonly proposal: Proposal; readonly view: FindingGuidanceView; readonly reviewer?: boolean;
}): ReactElement {
  return <div className="proposal-content">
    ...
    <h5>{reviewer ? 'Reviewer-authored confidence' : 'Model confidence'}</h5><p>{proposal.confidence}</p>
