...
import type { GenerationFit, GenerationRequest } from './generation-contract.ts';
...
export function prepareOllamaGenerationWire(request: GenerationRequest):
  { readonly ok: true; readonly body: string; readonly fit: GenerationFit }
  ...
  try {
    ...
    const fit: GenerationFit = Object.freeze({ accounting: QWEN_CONFIGURATION.accounting, inputTokens,
