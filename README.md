...
M5-02 implements conservative comparison at the [internal rescan boundary](#intentional-rescans). It uses exact scan-profile compatibility, unique target correlation and sufficient native evidence, with bounded rationale and explicit limitations. The UI and durable comparison record remain M5-03 work.
