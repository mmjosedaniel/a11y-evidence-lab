...
[M1-04 — Target and results UI](docs/plans/m1-04-target-and-results-ui.md) is In progress for the owner-selected OD-027 [Analyze and results presentation](docs/ui/ANALYZE_AND_RESULTS_PRESENTATION.md) replacement and renewed verification. Its earlier Analyze-only amendment and accepted evidence remain history. M1-05 remains Not started and unselected.
