...
| MVP evaluation manifest, expected outcomes, observed limitations, or deferred provider comparison, support qualification, and acceptance targets | [Evaluation and acceptance](requirements/evaluation-and-release/EVALUATION_AND_ACCEPTANCE.md) | [Delivery readiness and open decisions](requirements/DELIVERY_READINESS_AND_OPEN_DECISIONS.md), feasibility evidence, and applicable ADRs |
