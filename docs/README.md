...
| Local or Groq generation, per-run provider choice, structured-output capability, credentials, egress, or provider isolation | [Generation provider execution](requirements/generation-provider-and-model-lifecycle/GENERATION_PROVIDER_EXECUTION.md) | [ADR-0014](architecture/decisions/ADR-0014-groq-as-mvp-external-generation-provider.md), [Local MVP feasibility](LOCAL_MVP_FEASIBILITY.md), privacy/security requirements, and only the applicable evaluation material |
