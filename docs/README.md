...
| [Documentation-only Gherkin specifications](specs/README.md) | Derived observable-behavior view for future implementation and acceptance work | Specified but not executed. These files own no requirement, decision, implementation status, or acceptance evidence; their linked authorities control. |
