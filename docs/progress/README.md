...
| [M1-01](../DEVELOPMENT_ROADMAP.md#m1-01--define-the-minimum-run-and-scan-contracts) | [Minimum run and scan contracts](m1-01-run-and-scan-contracts.md) | [Task plan](../plans/m1-01-run-and-scan-contracts.md) | In progress (planning only) | 2026-08-30 |
