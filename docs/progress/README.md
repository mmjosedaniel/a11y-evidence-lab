...
M1-03 is now selected for planning only. Its [ExecPlan](../plans/m1-03-real-scan-and-evidence.md) preserves the frozen contracts/fixtures and separates two future TDD slices from conditional browser setup and pre-worker literal/command review. Fresh checks pass the existing 182 tests and strict typecheck. No scanner or browser acquisition has started; M1-04 and M1-05 remain unselected.
...
| [M1-03](../DEVELOPMENT_ROADMAP.md#m1-03--implement-the-real-exact-three-rule-scan-and-minimized-evidence) | [Real scan and evidence](m1-03-real-scan-and-evidence.md) | [Task plan](../plans/m1-03-real-scan-and-evidence.md) | In progress (planning only) | 2026-08-31 |
