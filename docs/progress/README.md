...
Use the table to find each task's concise outcomes and detailed evidence. Execution and retry histories remain in the linked records; this index adds no separate completion narrative.
...
| [M3-03](../DEVELOPMENT_ROADMAP.md#m3-03--integrate-qwen-local-generation-and-run-its-capacity-screen) | [Qwen adapter and capacity screen](m3-03-qwen-adapter-and-capacity-screen.md) | [Task plan](../plans/m3-03-qwen-adapter-and-capacity-screen.md) | In progress | 2026-09-10 |
...
- Keep one file for the task's lifetime. Append material dated checkpoints rather than creating daily or per-agent files. Use a few short outcome/evidence/next-action statements per checkpoint, with one useful lesson when warranted; link the plan for diagnosis, commands, and detailed retries.
