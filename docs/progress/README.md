...
| [M1-02](../DEVELOPMENT_ROADMAP.md#m1-02--establish-the-loopback-service-and-single-file-aggregate) | [Local service and aggregate](m1-02-local-service-and-aggregate.md) | [Task plan](../plans/m1-02-local-service-and-aggregate.md) | In progress — planning only | 2026-08-30 |
