...
[M1-04](../plans/completed/m1-04-target-and-results-ui.md) is Complete after the accepted OD-027 presentation, purpose-named component extraction, integrated-review correction, complete regression, independent reviews, exact cleanup, and documentation closure. [M1-05](../plans/completed/m1-05-walking-skeleton-integration.md) is Complete again after both post-closure corrections, 335 passing tests, strict TypeScript, fresh independent reviews, exact cleanup, and renewed documentation closure. Prior implementation, failures, and public smoke remain historical. The regenerated build and three empty scratch roots were removed; the pinned browser remains unchanged. [M2-01](../plans/completed/m2-01-closed-corpus-snapshot.md) is Complete. The frozen `wcag22-mvp-v1` snapshot contains exactly eight sources, 16 canonical passages and three gold mappings. Structural, reconstruction, five-negative and manual checks, fresh S0 and integrated reviews, exact capture cleanup and documentation closure passed. M2-02 is now [In progress for planning only](../plans/m2-02-embedding-retrieval-capacity-gate.md); no retrieval behavior exists.
...
| [M2-02](../DEVELOPMENT_ROADMAP.md#m2-02--implement-and-capacity-screen-lazy-local-exact-vector-retrieval) | [Embedding retrieval and capacity gate](m2-02-embedding-retrieval-capacity-gate.md) | [Task plan](../plans/m2-02-embedding-retrieval-capacity-gate.md) | In progress | 2026-09-04 |
