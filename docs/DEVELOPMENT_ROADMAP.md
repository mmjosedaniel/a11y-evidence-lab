...
- **Current task:** [M3-03 — Qwen adapter and capacity screen](plans/m3-03-qwen-adapter-and-capacity-screen.md) is Blocked on its real capacity prerequisites after G and both A/B implementation slices passed independent review. All 550 tests, strict TypeScript and client build pass. The owner-approved start-dependency amendments remain in force; authentic supported retrieval and the required reviewer interface are still absent. M3-04 and all other later tasks remain Not started.
