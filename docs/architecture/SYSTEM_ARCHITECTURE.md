...
| --- | --- |
| Browser interface | [App.tsx](../../src/client/App.tsx) composes the interaction. [Components](../../src/client/components) display findings, guidance, proposals, human decisions and comparisons. The [client responsibility folders](../DEVELOPMENT.md#client-code) contain request handling, form validation and response admission. The interface does not read local files or hold provider credentials. |
