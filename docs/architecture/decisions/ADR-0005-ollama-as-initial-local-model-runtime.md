...
- Validate local structured output against the application schema; runtime-level schema support does not replace application validation.
...
- Treat runtime installation, ownership, updates, repair, and uninstall as unresolved until OD-014 is accepted.
