...
### Manual visual-verification amendment recorded 2026-09-09

Explicit owner direction amended [REQ-A11Y-006](../../requirements/quality-security-and-operations/APPLICATION_ACCESSIBILITY.md#accessibility-of-a11y-evidence-lab) to automated accessibility, keyboard, focus and announcement-semantics checks plus manual visual review. This supersedes the manual keyboard/screen-reader smoke methods in the historical clarification above. Manual screen-reader testing is outside the portfolio scope; accessible implementation remains required and unobserved spoken behavior is not verified. This changes no React or application-boundary decision.

### 200% zoom verification deferral recorded 2026-09-15 UTC

The owner subsequently deferred every 200% zoom test until after the portfolio MVP. The [REQ-A11Y-006 verification amendment](../../requirements/quality-security-and-operations/APPLICATION_ACCESSIBILITY.md#200-zoom-verification-deferral--2026-09-15-utc) owns this timing change, including the former M2-03 carry to M6-03. Accessible zoom/reflow behavior remains required; historical results and omissions are preserved. This changes no React or application-boundary decision.
...
- Evaluate the application's core path against `REQ-A11Y-*` using the automated checks and manual visual review governed by `REQ-A11Y-006` and its verification amendments above. A formal assistive-technology support matrix remains deferred; browser evidence is required for visual claims that component tests cannot establish.
