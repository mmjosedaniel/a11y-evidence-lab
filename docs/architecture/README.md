...
| 3 | [Accessibility guidance retrieval assessments](candidates/guidance-retrieval/README.md) | Prepare the bounded three-rule guidance corpus and retrieve at most three cited passages for one selected finding through the in-process exact vector search accepted by ADR-0019. |
