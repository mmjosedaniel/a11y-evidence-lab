...
**Decision alignment:** 2026-08-27, including the trusted operator-input portfolio scope recorded by [OD-021](../../../requirements/DELIVERY_READINESS_AND_OPEN_DECISIONS.md#od-021--trusted-operator-url-boundary-for-the-portfolio-mvp) and [ADR-0018](../../decisions/ADR-0018-trusted-operator-url-boundary.md).
