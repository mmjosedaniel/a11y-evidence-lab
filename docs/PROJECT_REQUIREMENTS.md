...
| MVP behavioral specification, planning-level acceptance examples, evaluation authority, datasets, metrics, qualification, provider comparison, or acceptance targets | [Evaluation and acceptance](requirements/evaluation-and-release/EVALUATION_AND_ACCEPTANCE.md) is authoritative; [documentation-only Gherkin specifications](specs/README.md) provide a derived, non-executable view. |
