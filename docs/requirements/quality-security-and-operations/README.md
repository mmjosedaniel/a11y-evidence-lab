...
[OD-022](../DELIVERY_READINESS_AND_OPEN_DECISIONS.md#od-022--portfolio-mvp-yagni-simplification) records the cross-cutting portfolio simplification, and [ADR-0021](../../architecture/decisions/ADR-0021-single-file-run-aggregate.md) owns the accepted MVP persistence boundary.
