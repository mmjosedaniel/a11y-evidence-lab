...
| REQ-A11Y-006 | Acceptance must combine automated checks, manual keyboard review, and every supported screen-reader scenario in the browser and assistive-technology matrix approved under OD-009. The matrix must contain at least one pinned operating system, browser, and screen-reader combination covering the core review and comparison workflow. | Must | Proposed | Accessibility evaluation |
